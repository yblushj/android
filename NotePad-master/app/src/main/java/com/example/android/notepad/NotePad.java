...
public final class NotePad {
    ...
    public static final class Notes implements BaseColumns {
         ...
         */
        private static final String PATH_NOTE_ID = "/notes/";// 等下后面会添加一个#，表示一行
         ...
         */
        public static final Uri CONTENT_ID_URI_BASE // 基准，对应下面
         ...
         */
        public static final Uri CONTENT_ID_URI_PATTERN // 添加上一个#，对应上面
            = Uri.parse(SCHEME + AUTHORITY + PATH_NOTE_ID + "/#");
         ...
         */
        public static final String DEFAULT_SORT_ORDER = "modified DESC";// 用修改时间来排序
         ...
         * <P>Type: INTEGER (long from System.curentTimeMillis())</P>
         */
        public static final String COLUMN_NAME_MODIFICATION_DATE = "modified";//将修改的时间作为时间戳即可
    }
}
